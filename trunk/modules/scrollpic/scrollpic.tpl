...
<table  border="0"  cellspacing="1" bgcolor="#CCCCCC" width="100%">
	...
	<tr {if $key%2==1} class="tr2"{/if}>
		...
		<td class="main_td1" align="center" width="130"><a href="{$_A.query_url}/edit&id={$item.id}&a=system">修改</a> / <a href="#" onClick="javascript:if(confirm('确定要删除吗?删除后将不可恢复')) location.href='{$_A.query_url}/del&id={$item.id}&a=system'">删除</a></div>
	</div>
	{ /foreach}
	<tr >
