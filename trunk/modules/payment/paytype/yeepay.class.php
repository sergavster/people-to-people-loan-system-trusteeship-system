...
class yeepayPayment{
	...
	public static function ToSubmit($payment){
		...
		$p2_Order					= $payment['trade_no'];

		#	支付金额,必填.
		##单位:元，精确到分.
		$p3_Amt						= number_format($payment['money'], 2, '.', '');
		...
		$p8_Url						= "http://{$_SERVER['HTTP_HOST']}/modules/payment/yeepay_return.php";	
